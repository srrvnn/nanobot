...
- **2026-02-16** 🦞 nanobot now integrates a [ClawHub](https://clawhub.ai) skill — search and install public agent skills directly into `~/.nanobot/skills`.
...
- Use a different workspace per instance if you want isolated memory, sessions, and configs
